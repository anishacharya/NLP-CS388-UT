from src.data_utils.definitions import *
...
class LabelCountBinaryNER(object):
    """
...
def train_label_count_binary_ner(ner_exs: List[PersonExample]) -> LabelCountBinaryNER:
    """
    ...
    return LabelCountBinaryNER(pos_counts, neg_counts)
