...
def evaluate_binary_classifier(exs: List[PersonExample], classifier: BinaryPersonClassifier):
    ...
    print_binary_evaluation(golds, predictions)


def predict_binary_write_output_to_file(exs: List[PersonExample], classifier: BinaryPersonClassifier, outfile: str):
    """
...
def print_binary_evaluation(golds: List[int], predictions: List[int]):
    """
